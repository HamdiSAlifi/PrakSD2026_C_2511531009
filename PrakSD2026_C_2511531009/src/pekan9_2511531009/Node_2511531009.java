...
public class Node_2511531009 {
	...
	void printInorder_1009(Node_2511531009 node_1009) {
		if (node_1009 == null) {
			return;
		}
		printInorder_1009(node_1009.left_1009);
		System.out.print(node_1009.data_1009 + " ");
		printInorder_1009(node_1009.right_1009);
	}
	...
	private void print_1009(String prefix_1009, boolean isTail_1009) {
		if (right_1009 != null) {
			right_1009.print_1009(prefix_1009 + (isTail_1009 ? "|	" : "	"), false);
		}
		System.out.println(prefix_1009 + (isTail_1009 ? "\\-- " : "/-- ") + data_1009);
		if (left_1009 != null) {
			left_1009.print_1009(prefix_1009 + (isTail_1009 ? "	" : "|	"), true);
		}
	}
